<template>
  <div>
    ...
    <div v-if="showComponent">
      <div v-if="action === 'resetPasswordBefore'" class="z-40 width-100 flex-row center" style="padding-inline: 4rem;">
        <div class="card-component flex-column center gap-2" ref="ConfirmCard" style="max-width: 40rem;">
          <div class="subheading text-center">Reset Password</div>
          <div class="text-3 text-center">We will send you an email with a link to reset your password.</div>
      ...
      <div v-if="action === 'changeEmail'" class="absolute z-40">
        <div class="card-component flex-column center gap-2" ref="ConfirmCard">
          <div class="subheading">Change Email</div>
          ...
          <div v-if="error" class="text-3 text-error bold text-center">{{ error }}</div>
        </div>
      </div>
      <div v-if="action === 'changePassword'" class="absolute z-40">
        <div class="card-component flex-column center gap-2" ref="ConfirmCard">
      ...
      <div v-if="action === 'signOut'" class="absolute z-40">
        <div class="card-component flex-column center gap-2" ref="ConfirmCard">
          <div class="subheading">Sign Out?</div>
          <div class="button button-discouraged" @click="submit($event)">Confirm</div>
        </div>
      </div>
      <div v-if="action === 'deleteAccount'" class="absolute z-40">
        <div class="card-component flex-column center gap-2" ref="ConfirmCard">
