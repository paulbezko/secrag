...
widget_time_series_plot\
widget_basic_treemap_plot\
widget_multi_dimentional_treemap_plot - you can use it for visualizing profits and losses hyerarchically\
