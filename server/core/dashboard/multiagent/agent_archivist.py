...
get_latest_filings - Use ticker that you found using search_tickers or from the message history to search for metadata on ten latest filings that are available in the database for the input ticker. 
